...
exports.loginFetching = loginFetching;
function getLoginResponse(status) {
  return {
    type: 'loginResponse',
    payload: status
  };
...
exports.initLoginStatus = initLoginStatus;
exports.logIn = logIn;
exports.logOut = logOut;

var _facebookLogin = __webpack_require__(14);

var _actions = __webpack_require__(11);

function initLoginStatus() {
  return function (dispatch) {
    dispatch((0, _actions.loginFetching)());
    (0, _facebookLogin.loadFbSdk)().then(function (loadingResult) {
      return console.log(loadingResult, window.FB);
    }).then(function () {
      return (0, _facebookLogin.getLoginStatus)();
    }).then(function (response) {
      console.log('status connection', response);
      dispatch((0, _actions.getLoginResponse)(response.status));
    });
  };
}
function logIn() {
  return function (dispatch) {
    dispatch((0, _actions.loginFetching)());
    (0, _facebookLogin.fbLogin)().then(function (response) {
...
function logOut() {
  return function (dispatch) {
    dispatch((0, _actions.loginFetching)());
    (0, _facebookLogin.fbLogout)().then(function (response) {
      console.log(response.status);
      dispatch((0, _actions.getLoginResponse)(response.status));
    });
  };
...
var _thunks = __webpack_require__(12);
...
var _utilsStoreShape = __webpack_require__(4);
...
var _componentsProvider = __webpack_require__(26);

exports.Provider = _interopRequire(_componentsProvider);

var _componentsConnect = __webpack_require__(27);
