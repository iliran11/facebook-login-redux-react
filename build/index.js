...
var FacebookReduxLogin = function (_Component) {
  ...
  function FacebookReduxLogin(props) {
    ...
    _this.styles = (0, _merge2.default)({}, defaults.styles, props.style);
    _this.labels = (0, _merge2.default)({}, defaults.labels, props.lables);
    _this.verbose = _this.props.verbose;
    _this.state = {
      isWorking: false,
      isConnected: false
    };
  ...
  _createClass(FacebookReduxLogin, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _helpers.loadFbSdk)(this.props.appId).then(function (loadingResult) {
        if (_this2.verbose) console.info(loadingResult, window.FB);
      }).then(function () {
        return (0, _helpers.getLoginStatus)();
    ...
    value: function login() {
      ...
      (0, _helpers.fbLogin)().then(function (response) {
        if (_this3.verbose) console.info('login response', response);
        if (response.status === 'connected') {
          _this3.setState({ isConnected: true, isWorking: false });
        } else {
    ...
    value: function logout() {
      ...
      (0, _helpers.fbLogout)().then(function (response) {
        if (_this4.verbose) console.info('logout response', response);
        _this4.setState({
          isWorking: false,
          isConnected: false
        });
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { onClick: this.buttonClicked, style: this.styles.loginBtn },
          this.showSpinner(),
          this.getButtonText()
        )
      );
...
exports.default = FacebookReduxLogin;
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* eslint  no-unsed-vars:0 */
...
var Stack = __webpack_require__(43),
    assignMergeValue = __webpack_require__(16),
...
var assignMergeValue = __webpack_require__(16),
